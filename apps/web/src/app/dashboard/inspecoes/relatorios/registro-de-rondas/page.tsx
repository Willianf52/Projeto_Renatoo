  ...
  return (
    <div className="space-y-4">
      ...
      >
        ...
        <Suspense fallback={<FiltrosEmGradeEsqueleto celulas={14} colunas="xl:grid-cols-5" />}>
          <FormularioDeFiltros searchParams={searchParams} />
        </Suspense>

        <Suspense fallback={<TabelaEsqueleto colunas={12} linhas={6} minWidth={MIN_WIDTH} />}>
...
/**
 * GET nativo, mesmo mecanismo das demais telas. Linha 1 com largura propria
 * (Mes/Ano estreito, Coletor e Local flexiveis) e linhas 2/3 em grade de 5,
 * como na referencia -- Filtrar fica numa faixa cheia por baixo, e nao dentro
 * da grade.
 */
