...
export default function MapaDeLocaisInspecionadosPage({
  searchParams,
}: {
  ...
  return (
    <div className="space-y-4">
      ...
      >
        ...
        <Suspense fallback={<FiltrosEmGradeEsqueleto celulas={15} />}>
...
/**
 * GET nativo. Grade de 6 colunas (a partir de xl) como em Coletas Importadas:
 * 14 campos + Filtrar = 15 celulas, com col-start forcando a quebra nos mesmos
...
async function CorpoDoMapa({ searchParams }: { searchParams: SearchParamsPromise }) {
  ...
  const totalItems = mapa.linhas.length;
