 ...
 *
 * Mora aqui, e nao no app que precisar, porque o cargo e o que decide
 * autorizacao nos dois clientes: o painel web filtra e grava por ele, e o app
 * de campo so libera a tela de inspecao para INSPETOR. Um valor divergente
 * entre os dois nao daria erro de compilacao -- daria uma tela vazia num lado
 * e acesso indevido no outro.
 *
