 ...
 * persistir sessão. No app mobile isso é o Keystore, via `expo-secure-store`
 * (`apps/mobile/src/lib/armazenamento-seguro.ts`) — não importado aqui de
 * propósito, para este pacote não carregar uma dependência nativa de RN
 * (mantém a possibilidade de reuso fora do mobile).
 */
